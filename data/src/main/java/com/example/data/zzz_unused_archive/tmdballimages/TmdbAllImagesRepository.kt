...
//import com.example.muvitracker.data.dto.tmdb.old.filterNotUhdBackdrops
//import com.example.muvitracker.data.dto.tmdb.old.filterNotUhdPosters
//import com.example.muvitracker.data.dto.tmdb.old.toEntity
...
//            reader = { requestKeys ->
//                seasonImageDao.readSingle(requestKeys.showIds.trakt, requestKeys.seasonNr) // flow
//            },
...
//
//    // posters
//    fun getSeasonImageFlow(showIds: Ids, seasonNr: Int): Flow<Map<String, String>> {
//        return seasonImageStore.stream(
//            StoreRequest.cached(key = ShowRequestKeys(showIds, seasonNr), refresh = true)
//        )
//            .filterNot {
//                it is StoreResponse.Loading || it is StoreResponse.NoNewData
//            }
...
//                    showId = requestKeys.showIds.trakt,
...
//                    dto.toEntity(
//                        tmdbShowId = requestKeys.showIds.trakt,
//                        seasonNr = requestKeys.seasonNr,
//                        episodeNr = requestKeys.episodeNr
//                    )
//                )
...
//
//
//    fun getEpisodeImageFlow(showIds: Ids, seasonNr: Int, episodeNr: Int): Flow<Map<String, String>> {
//        return episodeImageStore.stream(
//            StoreRequest.cached(key = ShowRequestKeys(showIds, seasonNr, episodeNr), refresh = true)
//        )
//            .filterNot {
//                it is StoreResponse.Loading || it is StoreResponse.NoNewData
//            }

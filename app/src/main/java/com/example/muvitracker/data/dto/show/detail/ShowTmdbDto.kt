...
//    val adult: Boolean,
    @SerialName("backdrop_path") val backdropPath: String?, // "/zZqpAXxVSBtxV9qPBcscfXBcL2w.jpg"
//    @SerializedName("created_by") val createdBy: List<CreatorDto>, // NO
    @SerialName("episode_run_time") val episodeRunTime: List<Int>?, // [] - rimane vuoto su tmdb
    @SerialName("first_air_date") val firstAirDate: String?, // "2011-04-17"
...
//    @SerializedName("in_production") val inProduction: Boolean,
    ...
    @SerialName("last_air_date") val lastAirDate: String?, // 2019-05-19
...
//    @SerializedName("number_of_seasons") val numberOfSeasons: Int, //  8  NO
    @SerialName("origin_country") val originCountry: List<String>?, // ["US"]
    @SerialName("original_language") val originalLanguage: String?, // en
    @SerialName("original_name") val originalName: String?, // Games of Thrones
...
//    val type: String, // NO - Scripted;  altre: Reality, Documentary, Talk Show
    @SerialName("vote_average") val voteAverage: Double?, // 8.458,
...
data class NetworkDto (
    ...
    @SerialName("logo_path") val logoPath: String?, // es. "/tuomYjQdUqk2H1Zs2kA6dRpzQ7y.png"
    @SerialName("origin_country") val originCountry: String? // es. "US"
)
